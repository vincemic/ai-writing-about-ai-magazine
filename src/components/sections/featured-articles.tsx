          ...
          {articles.length === 0 ? (
            ...
            articles.map((article) => (
              <Link 
                ...
                className="group"
              >
                <article className="bg-gray-50 p-6 rounded-lg hover:shadow-lg transition-shadow h-full flex flex-col">
                      ...
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(article.author.name)}&background=3b82f6&color=white&size=32`;
                          }}
                        />
                        <div>
